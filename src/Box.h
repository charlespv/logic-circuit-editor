...
namespace Netlist
{
	class Box
	{
		public:
			...
			inline Box& inflate(int);
			inline Box& inflate(int, int);
			inline Box& inflate(int, int, int, int);
			inline Box& translate(int, int);
	...
	inline Box& Box::inflate(int dx, int dy) { return inflate(dx, dx, dy, dy); }
	...
	inline std::ostream& operator<<(std::ostream& o, const Box& box)
	{
